...
//            comment.comment = messageActivity_editText.text.toString()
//            comment.timestamp = System.currentTimeMillis()
//
//            FirebaseFirestore.getInstance().collection("images").document(contentUid!!).collection("comments").document().set(comment)
//            MessageAlarm(destinationUid!!,messageActivity_editText.text.toString())
//            messageActivity_editText.setText("")
//        }
//    }
//
//    fun MessageAlarm(destinationUid : String, message : String) {
...
//            view.messageItem_textView_message.text = comments[position].comment
//            view.messageItem_textview_name.text = comments[position].userId
//            view.messageItem_textView_time.text = comments[position].timestamp.toString()
